          ...
          <div className="hero-about-container">
            <div className="hero-about-card">
              ...
              <div className="hero-aboout-info">
                <h1>Media etikasi va raqamli transformatsiya </h1>
                <p>Media etikasi va raqamli transformatsiya axborot mas’uliyati va texnologik o‘zgarishlar uyg‘unligi.</p>
              </div>
            </div>
            <div className="hero-about-card">
              <div className="card-img">
              ...
              <div className="hero-aboout-info">
                <h1>Onlayn media etikasi va dolzarb muammolar</h1>
                <p>Onlayn media etikasi va dolzarb muammolar axborot ishonchliligi, maxfiylik va javobgarlik masalalari.</p>
              </div>
            </div>
            <div className="hero-about-card">
              <div className="card-img">
              ...
              <div className="hero-aboout-info">
                <h1>Real dilemmalar va amaliy holatlar</h1>
                <p>Real dilemmalar va amaliy holatlar axloqiy tanlov va qaror qabul jarayonlari.</p>
              </div>
            </div>
            <div className="hero-about-card">
              <div className="card-img">
            ...
            <div className="hero-about-card">
              ...
              <div className="hero-aboout-info">
                <h1>Huquqiy va institutsional mexanizmlar</h1>
                <p>Huquqiy va institutsional mexanizmlar media faoliyatini tartibga soluvchi norma va nazorat tizimlari.</p>
              </div>
            </div>
            <div className="hero-about-card">
              <div className="card-img">
              ...
              <div className="hero-aboout-info">
                <h1>Dezinformatsiya va manipulyatsiya</h1>
                <p>Dezinformatsiya va manipulyatsiya yolg‘on axborot orqali jamoatchilik fikrini boshqarish jarayoni.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="authors">
                <div className="authorProfile">
                  ...
                  <div className="authorInfo">
                      <p><strong>Nargis Qosimova</strong> (1969, Jizzax) — o‘zbek jurnalisti, filologiya fanlari doktori, professor. O‘zbekiston jurnalistika va ommaviy kommunikatsiyalar universitetida faoliyat yuritadi. Internet va eko-jurnalistika nazariyasi bo‘yicha tadqiqotlar olib boradi, „Ekolog“ jamoat birlashmasi direktori. 45 dan ortiq qo‘llanma va monografiya, 1000+ maqola muallifi, ko‘plab tanlovlar g‘olibi va ustoz-shogird tizimi rahbari.</p>
                  </div>
                </div>
                <div className="authorProfile">
                  <div className="authorPhoto">
